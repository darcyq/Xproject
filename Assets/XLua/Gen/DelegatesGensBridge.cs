...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp5(int p0, UnityEngine.GameObject p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp6(int p0, UnityEngine.Object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(System.Collections.Generic.List<string> p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<long>(__Gen_Delegate_Imp3);
			}
			...
			{
			    return new System.Action<int, UnityEngine.GameObject>(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(System.Action<int, UnityEngine.Object>))
			{
			    return new System.Action<int, UnityEngine.Object>(__Gen_Delegate_Imp6);
			}
			...
			{
			    return new System.Action<System.Collections.Generic.List<string>>(__Gen_Delegate_Imp8);
			}
